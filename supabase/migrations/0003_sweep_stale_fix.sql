-- 0003_sweep_stale_fix.sql
-- Fix sweep_stale() to resolve dangling retried attempts on crashed/interrupted runs per Invariant I6
...
declare
  ...
  v_locks_cleared int;
begin
  -- 1. Mark in-flight attempts on expired/aborted runs as failed
